...
```gradle
dependencies {
    implementation 'com.github.apiverve:websitetopdf-api:1.1.12'
}
```
...
```java
import com.apiverve.websitetopdf.WebsitetoPDFAPIClient;
import com.apiverve.websitetopdf.APIResponse;
import com.apiverve.websitetopdf.APIException;

// Initialize the client
WebsitetoPDFAPIClient client = new WebsitetoPDFAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/websitetopdf](https://docs.apiverve.com/ref/websitetopdf)
...
- **Documentation:** [https://docs.apiverve.com/ref/websitetopdf](https://docs.apiverve.com/ref/websitetopdf)
- **Issues:** [GitHub Issues](https://github.com/apiverve/websitetopdf-api/issues)
