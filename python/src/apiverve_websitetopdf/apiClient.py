...
class WebsitetopdfAPIClient:
    ...
    VALIDATION_RULES = {
        ...
        "marginTop": {"type": "number", "required": False, "default": "0.4"},
        "marginRight": {"type": "number", "required": False, "default": "0.4"},
        "marginBottom": {"type": "number", "required": False, "default": "0.4"},
        "marginLeft": {"type": "number", "required": False, "default": "0.4"},
    ...
    def execute(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:  # Returns WebsitetoPDFData in 'data' field
        """
