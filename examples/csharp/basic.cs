    ...
    class WebsitetoPDFExample
    {
        ...
        static async Task<JsonDocument> CallWebsitetoPDFAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { marginTop &#x3D; 0.4, marginBottom &#x3D; 0.4, marginLeft &#x3D; 0.4, marginRight &#x3D; 0.4, landscape &#x3D; false, url &#x3D; &quot;https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/concepts&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Website to PDF API...\n");

            var result = await CallWebsitetoPDFAPI();
