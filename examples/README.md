# Website to PDF API - Examples

This folder contains example code for using the Website to PDF API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/websitetopdf',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/websitetopdf");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/websitetopdf](https://docs.apiverve.com/ref/websitetopdf)
