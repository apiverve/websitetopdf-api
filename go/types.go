...
// Request contains the parameters for the Website to PDF API.
//
// Parameters:
...
type Request struct {
	MarginTop float64 `json:"marginTop,omitempty"` // Optional
	MarginBottom float64 `json:"marginBottom,omitempty"` // Optional
	MarginLeft float64 `json:"marginLeft,omitempty"` // Optional
	MarginRight float64 `json:"marginRight,omitempty"` // Optional
	Landscape bool `json:"landscape,omitempty"` // Optional
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"marginTop": {Type: "number", Required: false},
		"marginRight": {Type: "number", Required: false},
		"marginBottom": {Type: "number", Required: false},
...
// ResponseData contains the data returned by the Website to PDF API.
