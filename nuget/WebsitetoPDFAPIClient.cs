...
namespace APIVerve.API.WebsitetoPDF
{
    ...
    /// <summary>
    /// Client for the WebsitetoPDF API
    /// </summary>
    public class WebsitetoPDFAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/websitetopdf";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "marginTop", new ValidationRule { Type = "number", Required = false } },
            { "marginRight", new ValidationRule { Type = "number", Required = false } },
            { "marginBottom", new ValidationRule { Type = "number", Required = false } },
            { "marginLeft", new ValidationRule { Type = "number", Required = false } },
            { "landscape", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public WebsitetoPDFAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WebsitetoPDFAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WebsitetoPDFAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WebsitetoPDFQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WebsitetoPDFQueryOptions options)
        {
        ...
        public ResponseObj Execute(WebsitetoPDFQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WebsitetoPDFQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WebsitetoPDFQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WebsitetoPDFQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WebsitetoPDFQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WebsitetoPDFQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WebsitetoPDFQueryOptions options)
        {
